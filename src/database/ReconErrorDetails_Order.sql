...
CREATE OR REPLACE PACKAGE BODY recon_order_pkg AS
  ...
  AS
    ...
    OPEN c_results FOR 'SELECT STATUS_FOUND, SUB_ORD_REF_NUM, SOURCE_SYSTEM, CURRENCY_CODE, TOTAL_PRICE,  SAP_EIS_ORDER, CORE_LOAD_DATE_TIME, STATUS_CODE, STATUS_MSG FROM (
